    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "951350301594916",
               appSecret: "13514b1bade10387c6f13db0b17e31f7");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "386962011909-g80n08din4oti29cacq028m3uh6sa1tl.apps.googleusercontent.com",
                ClientSecret = "hzS3tXYDseY6qulBRShywNeS"
            });
        }
    }
}