...
{
    public class RestoValidator : ValidationAttribute, IClientValidatable
    {
        public string Parametre1 { get; set; }
        public string Parametre2 { get; set; }

        public RestoValidator() : base("Vous devez saisir au moins un moyen de contacter le restaurant")
    {
        }
